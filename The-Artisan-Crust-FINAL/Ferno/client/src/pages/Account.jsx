...
const Account = () => {
  ...
  return (
    <PageLayout title="Account" width="2xl" isFloating>
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
        <Link to="/dashboard" className="group bg-char-900 rounded-3xl p-6 shadow-sm border border-char-950/5 transition-all hover:shadow-md hover:-translate-y-1">
        ...
        <Link to="/history" className="group bg-char-900 rounded-3xl p-6 shadow-sm border border-char-950/5 transition-all hover:shadow-md hover:-translate-y-1">
          <div className="flex items-center justify-between">
