    ...
    <div className="doodle-bg min-h-[calc(100vh-104px)] px-0 md:px-6 pt-0 pb-8 md:py-20 flex flex-col items-center overflow-hidden">
      <div className="w-full max-w-5xl relative overflow-hidden flex flex-col items-center">
        ...
        <div className="mt-20 md:mt-28 w-full">
          <div className="grid grid-cols-3 gap-3 md:gap-8 items-stretch">
            {FEATURES.map((s, i) => (
              <motion.div
                key={s.step}
                ...
                className="group bg-[#FDF2F0] rounded-[24px] md:rounded-[40px] p-4 md:p-6 md:h-full md:min-h-[160px] shadow-xl border border-tomato/5 transition-all duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-2xl relative overflow-hidden flex flex-col items-center text-center justify-center"
              >
