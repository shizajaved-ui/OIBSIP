          ...
          <div className="grid grid-cols-3 gap-3 md:gap-8 items-start">
            {FEATURES.map((s, i) => (
              <motion.div
                ...
                className="group bg-[#FDF2F0] rounded-[24px] md:rounded-[40px] p-4 md:p-8 md:h-[180px] shadow-xl border border-tomato/5 transition-all duration-500 hover:-translate-y-2 hover:bg-white hover:shadow-2xl relative overflow-hidden flex flex-col items-center text-center justify-center"
              >
