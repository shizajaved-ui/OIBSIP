    ...
    <PageLayout title="Admin panel" width="5xl" isFloating>
      ...
      {tab === 'inventory' && (
        <div className="space-y-12">
          ...
          <div className="sticky top-[104px] z-20 -mx-6 md:-mx-12 mb-10 px-6 md:px-12 py-6 doodle-bg border-y border-char-950/15 relative overflow-hidden flex items-center justify-center shadow-md">
